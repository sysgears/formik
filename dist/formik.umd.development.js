    ...
    function (_super) {
      ...
      function Formik(props) {
        ...
        _this.runValidations = function (values) {
          ...
          var promise = makeCancelable(Promise.all([_this.runFieldLevelValidations(values), _this.props.validationSchema ? _this.runValidationSchema(values) : {}, _this.props.validate ? _this.runValidateHandler(values) : {}]).then(function (_a) {
